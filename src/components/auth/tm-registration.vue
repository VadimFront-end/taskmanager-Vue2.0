    ...
    <div class="content-form">
      ...
      <div class="container-input-log">
        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path
              ...
              :fill="(ERROR&&$v.name.$invalid) ? '#EC1B1B' : focusName ? '#4F8AFD' : '#A7B4CF'"/>
          <path d="M0.999846 14.5H14.9998V16H0.999846V14.5Z"
                :fill="(ERROR&&$v.name.$invalid) ? '#EC1B1B' : focusName ? '#4F8AFD' : '#A7B4CF'"/>
        </svg>
        <div class="input"
          ...
          <svg v-else-if="!$v.name.$invalid&&name.length" width="16" height="16" viewBox="0 0 16 16" fill="none"
               xmlns="http://www.w3.org/2000/svg">
            <circle cx="8" cy="8" r="8" fill="#2CCF11"/>
            <path d="M11.75 5L6.5 11L4.25 8.75" stroke="white" stroke-width="1.69643" stroke-linecap="round"
      ...
      <div class="container-input-log">
        ...
        <div class="input"
          ...
          <svg v-else-if="!$v.password.$invalid" width="16" height="16" viewBox="0 0 16 16" fill="none"
               xmlns="http://www.w3.org/2000/svg">
            <circle cx="8" cy="8" r="8" fill="#2CCF11"/>
            <path d="M11.75 5L6.5 11L4.25 8.75" stroke="white" stroke-width="1.69643" stroke-linecap="round"
                  stroke-linejoin="round"/>
      ...
      <div class="error" v-else-if="(ERROR&&!$v.password.passwordSigns)">Пароль должен содержать как минимум одну
        заглавную и строчную латинские буквы, цифру и спецсимвол
      </div>
      ...
      <div class="container-input-log">
        ...
        <div class="input"
          ...
          <svg v-else-if="!$v.passwordConfirm.$invalid" width="16" height="16" viewBox="0 0 16 16" fill="none"
               xmlns="http://www.w3.org/2000/svg">
            <circle cx="8" cy="8" r="8" fill="#2CCF11"/>
            <path d="M11.75 5L6.5 11L4.25 8.75" stroke="white" stroke-width="1.69643" stroke-linecap="round"
                  stroke-linejoin="round"/>
      ...
      <div class="conditions">Нажимая Зарегистрироваться я принимаю <span class="link-to-conditions">Правила использования сайта</span>
        и даю <span class="link-to-conditions">Согласие на обработку персональных данных</span></div>
      <router-link :to="'/'">
        <div class="link-to-authorization-items" style="text-align: center" @click="$store.commit('deleteError')">Уже
