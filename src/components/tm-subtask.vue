<template>
  <div class="tm-subtasks">
    ...
    <svg @click="deletingSubtask=true;editingSubtask=false" v-else style="cursor: pointer" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div v-show="deletingSubtask&&indexSubTask===indexFocus" style="display: flex;margin-left: 12px">
      ...
      <div @click="deleteSubtask(true)" style="cursor: pointer;margin: 0 16px;color: #EC1B1B;">Удалить</div>
      <div @click="deleteSubtask(false)" style="cursor: pointer;color: #485C83">Назад</div>
    </div>
  </div>
</template>
