   ...
   <div class="modal-window">
     ...
     <div class="persons">
       <div @mousemove="focusExecuter=true" @mouseout="focusExecuter=false">
         <div class="title-for-input-mw" :style="{visibility: focusExecuter ? 'visible': 'hidden',color: focusExecuter ? '#0356F6': ''}">Исполнитель</div>
           ...
           <div style="display: flex;align-items: center">
             ...
             <div class="container-for-input-edit-task" style="position: relative">
               ...
               <div class="container-for-arr" :style="{transform: focusExecuter ? 'rotate(180deg)': ''}">
                 <div class="arrow-for-small-task" style="transform: rotate(45deg);margin-right: -2px;background: #B0BCD3"></div>
                 <div class="arrow-for-small-task" style="transform: rotate(-45deg);margin-left: -2px;background: #B0BCD3"></div>
               </div>
     ...
     <div class="title-for-input-mw" :style="{color: focusDeadline ? '#0356F6': '',visibility: focusDeadline ? 'visible': 'hidden'}">Дедлайн</div>
     <div style="display: flex">
       <label style="display: flex;align-items: center;margin-right: 30px;cursor: pointer" for="label-clock-sand">
         ...
         <div class="container-for-input-edit-task" :style="{borderBottom: focusDeadline ? '1px solid #0356F6': ''}">
           ...
           <svg width="17" height="16" viewBox="0 0 17 16" fill="none" xmlns="http://www.w3.org/2000/svg">
             <path d="M4.79999 7.19995H6.39999V8.79995H4.79999V7.19995ZM4.79999 10.4H6.39999V12H4.79999V10.4ZM7.99999 7.19995H9.59999V8.79995H7.99999V7.19995ZM7.99999 10.4H9.59999V12H7.99999V10.4ZM11.2 7.19995H12.8V8.79995H11.2V7.19995ZM11.2 10.4H12.8V12H11.2V10.4Z" :fill="focusDeadline ? '#4F8AFD': '#A7B4CF'"/>
             <path d="M3.19998 16H14.4C15.2824 16 16 15.2824 16 14.4V3.2C16 2.3176 15.2824 1.6 14.4 1.6H12.8V0H11.2V1.6H6.39998V0H4.79998V1.6H3.19998C2.31758 1.6 1.59998 2.3176 1.59998 3.2V14.4C1.59998 15.2824 2.31758 16 3.19998 16ZM14.4 4.8L14.4008 14.4H3.19998V4.8H14.4Z" :fill="focusDeadline ? '#4F8AFD': '#A7B4CF'"/>
           </svg>
         </div>
       </label>
       <div style="display: flex;align-items: center">
     ...
     <div class="edit-tasks-time">
       ...
       <div>
         <div class="title-for-input-mw" :style="{color: focusTimeF ? '#0356F6': '',visibility: focusTimeF ? 'visible': 'hidden'}">Фактичекое время</div>
         <label style="display: flex;align-items: center;cursor: pointer" for="label-timeF">
           <svg style="margin-right: 8px" width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
             <g clip-path="url(#clip0)">
               <path d="M8 0C6.41775 0 4.87104 0.469192 3.55544 1.34824C2.23985 2.22729 1.21447 3.47672 0.608967 4.93853C0.00346627 6.40034 -0.15496 8.00887 0.153721 9.56072C0.462403 11.1126 1.22433 12.538 2.34315 13.6569C3.46197 14.7757 4.88743 15.5376 6.43928 15.8463C7.99113 16.155 9.59966 15.9965 11.0615 15.391C12.5233 14.7855 13.7727 13.7602 14.6518 12.4446C15.5308 11.129 16 9.58225 16 8C16 6.94943 15.7931 5.90914 15.391 4.93853C14.989 3.96793 14.3997 3.08601 13.6569 2.34315C12.914 1.60028 12.0321 1.011 11.0615 0.608964C10.0909 0.206926 9.05058 0 8 0ZM8 14.4C6.7342 14.4 5.49683 14.0246 4.44435 13.3214C3.39188 12.6182 2.57158 11.6186 2.08717 10.4492C1.60277 9.27973 1.47603 7.9929 1.72298 6.75142C1.96992 5.50994 2.57946 4.36957 3.47452 3.47452C4.36958 2.57946 5.50995 1.96992 6.75143 1.72297C7.9929 1.47603 9.27973 1.60277 10.4492 2.08717C11.6186 2.57157 12.6182 3.39188 13.3214 4.44435C14.0246 5.49683 14.4 6.7342 14.4 8C14.4 9.69739 13.7257 11.3253 12.5255 12.5255C11.3253 13.7257 9.69739 14.4 8 14.4Z" :fill="focusTimeF ? '#4F8AFD': '#A7B4CF'"/>
               <path d="M11.2 7.2H8.80001V4.8C8.80001 4.58783 8.71573 4.38434 8.5657 4.23431C8.41567 4.08429 8.21219 4 8.00001 4C7.78784 4 7.58436 4.08429 7.43433 4.23431C7.2843 4.38434 7.20001 4.58783 7.20001 4.8V8C7.20001 8.21217 7.2843 8.41566 7.43433 8.56569C7.58436 8.71571 7.78784 8.8 8.00001 8.8H11.2C11.4122 8.8 11.6157 8.71571 11.7657 8.56569C11.9157 8.41566 12 8.21217 12 8C12 7.78783 11.9157 7.58434 11.7657 7.43431C11.6157 7.28429 11.4122 7.2 11.2 7.2Z" :fill="focusTimeF ? '#4F8AFD': '#A7B4CF'"/>
             </g>
             <defs>
               <clipPath id="clip0">
                 <rect width="16" height="16" fill="white"/>
